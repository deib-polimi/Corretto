...
;;org.correttouml.uml.diagrams.classdiagram.Clock@71d383fdSEMANTICS
...
;;Attribute semantics
(-> (!! (||  (-P- OBJradarASSIGNMENT_T^O^_^MYISGE^E^A^H^_^P^KLU^TOM^OAfailureC) (-P- OBJradarASSIGNMENT_LQ^V2^GISOE^E^A^H^_^P^KLU^TOM^OAfailureC))) ([=] (-V- OBJradarATTRfailureC) (yesterday (-V- OBJradarATTRfailureC))))

;;radar AD OBJradaradRadarorg.correttouml.uml.diagrams.activitydiagram.AD@294d1a3a SEMANTICS
...
(<-> (-P- OBJradarOPreadValue) (||  (-P- CONTROLFLOW_41LXQISGE^E^A^H^_^P^KLU^TOM^OA) (-P- CONTROLFLOW_8^RP^P4ISGE^E^A^H^_^P^KLU^TOM^OA)))
...
(<-> (&&  (-P- OBJradarOPreadValue) (-P- CONTROLFLOW_8^RP^P4ISGE^E^A^H^_^P^KLU^TOM^OA)) (||  (-P- CONTROLFLOW_A^Q^AJ8ISOE^E^A^H^_^P^KLU^TOM^OA) (-P- CONTROLFLOW_R41^K0ISOE^E^A^H^_^P^KLU^TOM^OA)))
...
;;brakeS STD brakingSMorg.correttouml.uml.diagrams.statediagram.StateDiagram@2f45cb9 SEMANTICS
...
;;ctrl STD controllerSMorg.correttouml.uml.diagrams.statediagram.StateDiagram@3f12ccc4 SEMANTICS

;;STATE noAction
(-> (-P- BigBang) (!! (-P- $OBJctrl_STDcontrollerSM_STATEnoAction)))
(-> (-P- BigBang) (next (-P- OBJctrl_STDcontrollerSM_STATEnoAction_ENTER)))
(-> (-P- OBJctrl_STDcontrollerSM_STATEnoAction_ENTER) (yesterday (||  (-P- BigBang) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^VYX8UAODE^EKTX^BQ^Z^TIL^H3^G))))
...
(-> (-P- OBJctrl_STDcontrollerSM_STATEwarning_EXIT) (||  (-P- OBJctrl_STDcontrollerSM_TRANSITION_^Q^G^XUMAODE^EKTX^BQ^Z^TIL^H3^G) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G)))
...
(-> (&&  (-P- $OBJctrl_STDcontrollerSM_STATEwarning) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^Q^G^XUMAODE^EKTX^BQ^Z^TIL^H3^G_TRIGGER) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^Q^G^XUMAODE^EKTX^BQ^Z^TIL^H3^G_GUARD)) (||  (-P- OBJctrl_STDcontrollerSM_TRANSITION_^Q^G^XUMAODE^EKTX^BQ^Z^TIL^H3^G) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G)))
...
(-> (&&  (-P- $OBJctrl_STDcontrollerSM_STATEwarning) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G_TRIGGER) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G_GUARD)) (||  (-P- OBJctrl_STDcontrollerSM_TRANSITION_^Q^G^XUMAODE^EKTX^BQ^Z^TIL^H3^G) (-P- OBJctrl_STDcontrollerSM_TRANSITION_^O^U^U^U0AODE^EKTX^BQ^Z^TIL^H3^G)))
...
;;IOD IOD
(<-> (-P- IOD_readValue_START) (past (||  (-P- IOD_readValue_END) (-P- IOD_^PN^S^F^KAN_E^EKTX^BQ^Z^TIL^H3^G_START)) 1))
...
;;; PROPERTIES
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defvar Q1 (alw (-> (lasted (&&  ([<] (-V- SDsendSensorDistancePARdistance) 2) (!! (-P- failure))) 45) (withinp (-P- $OBJbrakeS_STDbrakingSM_STATEbraking) 45))))
