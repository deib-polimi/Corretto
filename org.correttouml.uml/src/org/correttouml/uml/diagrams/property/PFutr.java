...
public class PFutr implements PBooleanFormulae {

	private NamedElement uml_element;
	
	public PFutr(NamedElement uml_element) {
		this.uml_element=uml_element;
	}

	public PBooleanFormulae getFormulae() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "Futr");
