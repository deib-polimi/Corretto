...
public class PYesterday implements PBooleanFormulae {

	private NamedElement uml_element;

	public PYesterday(NamedElement uml_element) {
		this.uml_element=uml_element;
	}

	public PBooleanFormulae getFormulae() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "Yesterday");
