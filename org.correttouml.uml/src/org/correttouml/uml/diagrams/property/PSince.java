...
public class PSince implements PBooleanFormulae {

	private NamedElement uml_element;
	
	public PSince(NamedElement uml_element) {
		this.uml_element=uml_element;
	}

	public PBooleanFormulae getLeft() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "Since");
