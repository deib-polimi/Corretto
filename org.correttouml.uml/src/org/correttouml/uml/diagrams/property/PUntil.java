...
public class PUntil implements PBooleanFormulae {

	private NamedElement uml_element;
	
	public PUntil(NamedElement uml_element) {
		this.uml_element=uml_element;
	}

	public PBooleanFormulae getLeft() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "Until");
