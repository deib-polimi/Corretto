...
public class PWithinF implements PBooleanFormulae {

	private NamedElement uml_element;
	
	public PWithinF(NamedElement uml_element) {
	...
	public PBooleanFormulae getFormulae() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "WithinF");
