...
public class PAnd implements PBooleanFormulae {

	private NamedElement uml_element;

	public PAnd(NamedElement uml_element) {
		this.uml_element=uml_element;
	}

	public PBooleanFormulae getLeft() {
		Stereotype uml_stereotype=UML2ModelHelper.getStereotype(uml_element, "And");
